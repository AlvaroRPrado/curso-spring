...
@EnableWebMvc
@EnableSpringDataWebSupport//para paginação
@EnableCaching
@EnableAsync
public class WebConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
	...
	public FormattingConversionService mvcConversionService() {
		 ...
		 * conversionService.addFormatterForFieldType(BigDecimal.class,
		 * bigDecimalFormatter); NumberStyleFormatter integerFormatter = new
		 * NumberStyleFormatter("#,##0");
		 * conversionService.addFormatterForFieldType(Integer.class,
		 * integerFormatter);
		 */
