...
@Entity
@Table(name = "cliente")
@GroupSequenceProvider(ClienteGroupSequenceProvider.class)//valida o bean seguindo uma sequencia
public class Cliente implements Serializable {
	...
	@PostLoad// recuperando formatação do cnpj e cpf pra pesquisa
